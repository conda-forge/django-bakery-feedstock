...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-bakery-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-bakery-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-bakery
# for installing globally
pixi global install django-bakery
```
...
It is possible to list all of the versions of `django-bakery` available on your platform:
...
```
pixi search django-bakery --channel conda-forge
```
